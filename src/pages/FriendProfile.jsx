...
import { FaGamepad, FaClock, FaTrophy, FaUserFriends, FaComment } from 'react-icons/fa';
  ...
  return (
    <Container maxW="container.xl" py={8}>
      <VStack spacing={8} align="stretch">
        ...
        {/* Recent Games */}
        <Box>
          <Heading size="md" mb={4} color="whiteAlpha.900">Recent Games</Heading>
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6}>
        ...
        {/* Recent Achievements */}
        <Box>
          <Heading size="md" mb={4} color="whiteAlpha.900">Recent Achievements</Heading>
            ...
            {friend.achievements.map((achievement) => (
              ...
              >
                <HStack justify="space-between">
                  ...
                  <Text color="gray.400">{achievement.date}</Text>
                </HStack>
              </Box>
            ))}
          </VStack>
